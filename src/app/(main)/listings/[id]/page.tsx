...
export default async function ListingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="relative aspect-[4/3] w-full rounded-2xl overflow-hidden bg-slate-900 border border-white/10">
            {mainPhoto ? (
              <Image src={mainPhoto} alt={listing.title} fill className="object-contain bg-black/40" sizes="(max-width: 1024px) 100vw, 66vw" onError={undefined} />
            ) : (
          ...
          <div className="glass-card p-6 rounded-2xl">
            ...
            {isSold && (
              <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700 mt-4 text-center">
                ...
                {(currentUser?.id === listing.selected_bidder_id || isSeller) && (
      ...
      {/* Seller Bid Dashboard — shown for any active listing */}
      {isSeller && !isRemoved && (
        <div className="mt-10">
